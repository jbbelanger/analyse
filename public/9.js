...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    infoWindowResultats: function infoWindowResultats() {
      if (this.infoContent) {
        return this.infoContent.sectionresultats.sort(function (a, b) {
          return b.bv - a.bv;
        });
      } else {
        return null;
    ...
    partis: function partis() {
      var flat = this.resultats.map(function (r) {
        return r.sectionresultats.map(function (s) {
          return s.parti;
        });
      }).flat();
      ...
      if (_this.resultats.length > 0) {
        ...
        try {
          for (var _iterator = data[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            var geojson = JSON.parse(section.sectionpolygone.polygone);
            var pgon;
            ...
            if (geojson.geometry) {
              ...
              try {
                for (var _iterator2 = geojson.geometry.coordinates[0][Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                  var a = _step2.value;
                  arr.push(a.map(function (p) {
                    return {
                      lng: p[0],
                      lat: p[1]
                    };
            ...
            if (section.sectionresultats.length > 0 && section.sectionpolygone) {
              ...
              try {
                for (var _iterator3 = section.sectionresultats[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                  var r = _step3.value;
  ...
  methods: {
    get: function get() {
      ...
      this.error = null;
      this.loading = true;
      axios.get("/api/circonscriptions/".concat(this.$route.params.circonscriptionId, "/elections/").concat(this.$route.params.electionId, "/resultats_section/polygones?page=").concat(this.page)).then(function (response) {
        var _iteratorNormalCompletion4 = true;
        var _didIteratorError4 = false;
        var _iteratorError4 = undefined;

        try {
          for (var _iterator4 = response.data.resultats.data[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
            var d = _step4.value;
                          ...
                          _c("p", { staticClass: "text-center caption" }, [
                            _vm._v(
                              "\n            Nombre total de bulletins valides : " +
                                _vm._s(
                                  _vm._f("numeralFormat")(
                                    _vm.infoContent.sectionresultats[0].bv
                                  )
                                ) +
                                " (" +
                                _vm._s(
                                  _vm._f("numeralFormat")(
                                    _vm.infoContent.sectionresultats[0].pc_bv,
                                    "0.00 %"
                                  )
                                ) +
                                ")"
                            ...
                            _vm._v(
                              "\n            Nombre total de bulletins rejetés : " +
                                _vm._s(
                                  _vm._f("numeralFormat")(
                                    _vm.infoContent.sectionresultats[0].br
                                  )
                                ) +
                                " (" +
                                _vm._s(
                                  _vm._f("numeralFormat")(
                                    _vm.infoContent.sectionresultats[0].pc_br,
                                    "0.00 %"
                                  )
                                ) +
                                ")"
                            ...
                            _vm._v(
                              "\n            Vote exercé : " +
                                _vm._s(
                                  _vm._f("numeralFormat")(
                                    _vm.infoContent.sectionresultats[0].ve
                                  )
                                )
                            ),
                            _c("br"),
                            _vm._v(
                              "\n            Nombre total d'électeurs inscrits : " +
                                _vm._s(
                                  _vm._f("numeralFormat")(
                                    _vm.infoContent.sectionresultats[0].ei
                                  )
                                )
                            ),
                            _c("br"),
